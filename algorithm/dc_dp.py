...
#===========================================================
# 1. k번째 작은 수 찾는 문제 (kth smallest selction problem)
...
def quick_select(A, left, right, k):
    if left == right: # 재귀 함수 호출 종료
        return A[left]
    pos = partition(A, left, right) # 피벗을 배열 A에 첫번째 요소로 설정
    if k + left == pos + 1: # case 1 - 피벗이 k번째인 경우
        return A[pos]
    elif k + left < pos + 1: # case 2 - k번째 작은수가 왼쪽에 있는 경우
        return quick_select(A, left, pos - 1, k)
    else: # case 3 - k번째 작은 수가 오른쪽에 있는 경우
...
#==============================================================
# 1. 파보나치 수열 문제(fibonacci sequence)
